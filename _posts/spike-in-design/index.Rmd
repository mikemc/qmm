---
title: "Considerations for designing spike-in experiments"
description: |
  Some considerations for designing spike-ins for absolute-abundance
  calibration in community sequencing experiments.
author:
...
*Status: Preliminary speculations.*
